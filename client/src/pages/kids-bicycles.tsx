...
import { FilterValues, BicycleFiltersProps } from "@/types/filters";
...
export default function BicycleFilters({
  filters: externalFilters, // Renamed to avoid conflict with local state
  onFilterChange,
  onSortChange,
}: BicycleFiltersProps) {
  const [filters, setFilters] = useState<FilterValues>(externalFilters || {});
  const [priceRange, setPriceRange] = useState([
    externalFilters?.minPrice || 0, 
    externalFilters?.maxPrice || 50000
  ]);
